            ...
            <div class="content-left">
              <div class="note">
                ...
                <div class="note-content">
                  <p>website <strong>VDO</strong> là một sản phẩm của đồ án tốt nghiệp đề tài: <i> Xây dựng Website bán hàng điện tử trực tuyến cho Công ty TNHH Dữ liệu Trực tuyến Việt Nam chạy được trên cả máy tính và thiết bị di động</i>. Được thực hiện bởi sinh viên Nguyễn Thành Trung - ĐH SG - Địa Chất. Mọi hoạt động mua sắm trên website đều không có giá trị !</p>
                </div>
              </div>
              <div class="content">
                ...
                <p>Trên những cơ sở đó, đồ án tốt nghiệp của em thực hiện đề tài <i>“Xây dựng Website bán hàng điện tử trực tuyến cho Công ty TNHH Dữ liệu Trực tuyến Việt Nam”</i> nhằm giải quyết các nhu cầu quảng bá và kinh doanh sản phẩm hướng trực tiếp đến khách hàng trên mọi miền đất nước, thậm chí là quốc tế.</p>
              </div>
            </div>
          </div>
